...
you can change it to [another template](http://opendkim.org/opendkim.conf.5.html) (section Reserved Template Names) if you wish with `RSYSLOG_REMOTE_TEMPLATE` variable.
